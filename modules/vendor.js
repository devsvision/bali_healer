  ...
  return `
    <section class="mx-auto max-w-7xl px-4 py-12 lg:px-8">
      <div class="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          <p class="text-sm font-semibold uppercase tracking-[0.28em] text-goldSoft">Vendor / Agent</p>
          ...
          <p class="mt-5 leading-8 text-mist/65">Vendors can be individual healers, wellness studios, retreat companies, or agents managing multiple healers and service packages.</p>
        ...
        <div class="rounded-lg border border-gold/20 bg-panel p-5">
          <h3 class="text-xl font-semibold text-white">Vendor onboarding form</h3>
          <div class="mt-5 grid gap-4">
            <input class="rounded-lg border border-gold/20 bg-black px-4 py-3 text-sm text-white outline-none" placeholder="Vendor / healer name" />
            <select class="rounded-lg border border-gold/20 bg-black px-4 py-3 text-sm text-white outline-none"><option>Individual Healer</option><option>Wellness Company</option><option>Agent / Organizer</option></select>
