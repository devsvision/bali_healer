  ...
  return `
    <section class="mx-auto max-w-7xl px-4 py-12 lg:px-8">
      <div class="rounded-lg border border-gold/20 bg-panel p-5 md:p-8">
        ...
        <h2 class="mt-3 text-4xl font-semibold text-white">Find services by healing mode.</h2>
        <div class="mt-6 grid gap-3 md:grid-cols-4">
          ...
          <select class="rounded-lg border border-gold/20 bg-black px-4 py-3 text-sm text-white outline-none focus:border-gold"><option>All modes</option><option>Online</option><option>Offline</option><option>Hybrid</option></select>
          ...
          <button class="rounded-lg bg-gold px-5 py-3 text-sm font-bold text-black">Filter</button>
        </div>
      </div>
          ...
          <article class="overflow-hidden rounded-lg border border-gold/15 bg-panel">
            ...
            <div class="p-5">
              ...
              <div class="mt-5 flex items-center justify-between">
                <p class="font-semibold text-goldSoft">${service.price}</p>
